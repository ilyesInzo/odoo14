...
#     @http.route('/school_student/', auth='public')
#     def index(self, **kw):
#         return "Hello, world"

#     @http.route('/school_student/objects/', auth='public')
#     def list(self, **kw):
...
#     @http.route('/school_student/objects/<model("school.student"):obj>/', auth='public')
